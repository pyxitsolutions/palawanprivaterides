...
export const tours: Tour[] = [
  {
    ...
    pricing: [
      { vehicle: 'Sedan/Hatchback', price: '6900' },
      { vehicle: 'SUV', price: '7400' },
      { vehicle: 'Van', price: '7900' },
    ],
  },
  {
    images: [rides1],
  ...
  },
  {
    ...
    credit: 'fabionodariphoto.com',
    pricing: [
      { vehicle: 'Sedan/Hatchback', price: '5400' },
      { vehicle: 'SUV', price: '5900' },
      { vehicle: 'Van', price: '6400' },
    ],
  },
  {
    images: [rides2],
    name: 'Port Barton → PPS',
    price: '5400',
    type: 'Private Ride',
    duration: 'Travel Duration (2-3 hrs)',
    pax: 'Up to 8 pax',
    description: 'Private transfer from Port Barton back to Puerto Princesa. Comfortable, air-conditioned ride door-to-door with a trusted local driver — no shared vans.',
    credit: 'fabionodariphoto.com',
    pricing: [
      { vehicle: 'Sedan/Hatchback', price: '5400' },
      { vehicle: 'SUV', price: '5900' },
  ...
  },
  {
    ...
    credit: 'fabionodariphoto.com',
    pricing: [
      { vehicle: 'Sedan/Hatchback', price: '5900' },
      { vehicle: 'SUV', price: '6400' },
      { vehicle: 'Van', price: '6900' },
    ],
  },
  {
    images: [rides3],
    name: 'San Vicente → PPS',
    price: '5900',
    type: 'Private Ride',
    duration: 'Travel Duration (3-4 hrs)',
    pax: 'Up to 8 pax',
    description: 'Private transfer from San Vicente back to Puerto Princesa. Comfortable and exclusive ride with your group — no shared vans, no crowded trips.',
    credit: 'fabionodariphoto.com',
    pricing: [
      { vehicle: 'Sedan/Hatchback', price: '5900' },
      { vehicle: 'SUV', price: '6400' },
  ...
  },
  {
    ...
    pricing: [
      { vehicle: 'Sedan/Hatchback', price: '2900' },
      { vehicle: 'SUV', price: '3400' },
      { vehicle: 'Van', price: '3900' },
    ],
  },
  {
    images: [rides4],
    name: 'Astoria Palawan → PPS',
    price: '2900',
    type: 'Private Ride',
    duration: 'Travel Duration (2 hrs)',
    pax: 'Up to 8 pax',
    description: 'Private transfer from Astoria Palawan back to Puerto Princesa. Affordable and comfortable door-to-door service.',
    pricing: [
      { vehicle: 'Sedan/Hatchback', price: '2900' },
      { vehicle: 'SUV', price: '3400' },
      { vehicle: 'Van', price: '3900' },
  ...
  },
  {
    ...
    pricing: [
      { vehicle: 'Sedan/Hatchback', price: '3400' },
      { vehicle: 'SUV', price: '3900' },
      { vehicle: 'Van', price: '4400' },
    ],
  },
  {
    images: [rides5],
    name: 'Sabang · Four Points → PPS',
    price: '3400',
    type: 'Private Ride',
    duration: 'Travel Duration (2 hrs)',
    pax: 'Up to 8 pax',
    description: 'Private transfer from Sabang back to Puerto Princesa. Comfortable and reliable door-to-door service after your Underground River visit.',
    pricing: [
      { vehicle: 'Sedan/Hatchback', price: '3400' },
      { vehicle: 'SUV', price: '3900' },
      { vehicle: 'Van', price: '4400' },
  ...
  },
  {
    ...
    pax: 'Per person',
    description: 'Visit the UNESCO World Heritage Underground River in Sabang. ₱2,500 per person includes private van transport, boat transfers, licensed guide, buffet lunch, and permits. 🌿 Environmental fee: ₱150 per person (paid separately). Permits must be arranged in advance.',
    whatsIncluded: [
  ...
  },
  {
    ...
    pax: 'Per person',
    description: 'Island-hop Cowrie Island, Luli Island & Pambato Reef. ₱1,800 per person includes roundtrip van transfer, island hopping boat, entrance fees, licensed tour guide, lunch, and life vest. 🌿 Environmental fee: ₱150 per person (paid separately).',
    whatsIncluded: [
  ...
  },
  {
    ...
    pax: 'Per person',
    description: 'Most popular route — Big Lagoon, Secret Lagoon, Shimizu Island & Seven Commandos Beach. ₱1,500 per person tour rate. 🌿 Environmental fee: ₱400 per person. 🎫 Entrance fee (Big Lagoon): ₱200 per person.',
    whatsIncluded: [
      'Licensed Tour Guide',
      'Island Hopping Boat',
      'Life Vest',
  ...
  },
  {
    ...
    duration: 'Full Day Tour',
    pax: 'Per person',
    description: 'Caves & hidden beaches — Snake Island, Cudugnon Cave, Cathedral Cave & Entalula Beach. ₱1,600 per person tour rate. 🌿 Environmental fee: ₱400 per person (paid separately).',
    whatsIncluded: [
      'Licensed Tour Guide',
      'Island Hopping Boat',
      'Life Vest',
  ...
  },
  {
    ...
    duration: 'Full Day Tour',
    pax: 'Per person',
    description: 'Hidden beaches & snorkeling — Hidden Beach, Secret Beach, Matinloc Shrine & Helicopter Island. ₱1,700 per person tour rate. 🌿 Environmental fee: ₱400 per person. 🎫 Entrance fee (Matinloc Shrine): ₱200 per person.',
    whatsIncluded: [
      'Licensed Tour Guide',
      'Island Hopping Boat',
      'Life Vest',
  ...
  },
  {
    ...
    duration: 'Full Day Tour',
    pax: 'Per person',
    description: 'Quiet lagoons & relaxing spots — Small Lagoon, Cadlao Lagoon, Pasandigan Beach & Paradise Beach. ₱1,500 per person tour rate. 🌿 Environmental fee: ₱400 per person. 🎫 Entrance fee (Small Lagoon): ₱200 per person.',
    whatsIncluded: [
      'Licensed Tour Guide',
      'Island Hopping Boat',
      'Life Vest',
