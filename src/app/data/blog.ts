...
export const blogPosts: BlogPost[] = [
  {
    ...
    metaDescription: 'Everything you need to know about getting from Puerto Princesa to El Nido — travel time, transport options, costs, and tips. Private van transfer starting at ₱7,000 per booking.',
    ...
    content: [
      ...
      { type: 'p', text: 'Private transfers are priced per booking (whole vehicle), not per person. Current rates:' },
      {
        type: 'priceBox',
        priceTitle: 'Puerto Princesa → El Nido',
        priceRows: [
          { vehicle: 'Sedan / Hatchback', price: '7,000' },
          { vehicle: 'SUV', price: '7,500' },
          { vehicle: 'Van (up to 13 pax)', price: '8,000' },
        ],
  ...
  },
  {
    ...
    metaDescription: 'Getting from Puerto Princesa to Port Barton? Transport options, travel time, and costs. Private transfer from ₱5,500 per booking.',
    ...
    content: [
      ...
      { type: 'p', text: 'A private van transfer is the most comfortable and hassle-free way to reach Port Barton. Palawan Private Rides offers direct, door-to-door transfers per booking (whole vehicle).' },
      {
        type: 'priceBox',
        priceTitle: 'Puerto Princesa → Port Barton',
        priceRows: [
          { vehicle: 'Sedan / Hatchback', price: '5,500' },
          { vehicle: 'SUV', price: '6,000' },
          { vehicle: 'Van', price: '6,500' },
        ],
